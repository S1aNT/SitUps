...
public class MainActivity extends Activity   {
    private final String DEBUG_TAG ="ZanyX_MainActivity";
    ...
    public final static String BROADCAST_ACTION = "com.zanyxdev.SitUps";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        br = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Log.d(DEBUG_TAG, "onReceive: task = " + task + ", status = " + status);
    ...
    public void onClickStart(View v) {
        ...
        intent = new Intent(this, AccLoggerService.class).putExtra(PARAM_TIME, 7)
                .putExtra(PARAM_TASK, TASK1_CODE);
        // стартуем сервис
        startService(intent);

        intent = new Intent(this, AccLoggerService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_TASK, TASK2_CODE);
        startService(intent);

        intent = new Intent(this, AccLoggerService.class).putExtra(PARAM_TIME, 6)
